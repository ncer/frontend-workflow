...
Выдирать текст из слоев редактора неудобно и долго. Самый быстрый способ сразу получить весь текст из макета: с помощью [скрипта](https://github.com/pivanov/photoshop-scripts). Кроме того, можно загрузить макет в [Adobe Assets](https://assets.adobe.com) - этот способ чуть менее долгий, чем копирование из редактора.
